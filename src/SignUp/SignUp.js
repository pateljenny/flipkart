            ...
            <div id="main-registration-container">
                <div id="register">
                    ...
                    <form method="post" name="userRegistrationForm" onSubmit={this.submituserRegistrationForm} >
                        ...
                        <input type="text" name="emailid" placeholder="cool@play.com"value={this.state.fields.emailid} onChange={this.handleChange} />
                        ...
                        <label><i className="material-icons">phone_iphone</i></label>
                        <input type="text" name="mobileno" placeholder="+123647889" value={this.state.fields.mobileno} onChange={this.handleChange} />
